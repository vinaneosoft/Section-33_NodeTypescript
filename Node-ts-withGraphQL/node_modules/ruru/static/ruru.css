...
:is(.CodeMirror-foldgutter-open, .CodeMirror-foldgutter-folded):after {
  margin: 0 var(--px-2);
}
.CodeMirror-hints {
...
:is(.graphiql-container, .CodeMirror-info, .CodeMirror-lint-tooltip, .graphiql-dialog) {
  color: hsl(var(--color-neutral));
  font-family: var(--font-family);
  font-size: var(--font-size-body);
...
:is(.graphiql-container, .CodeMirror-info, .CodeMirror-lint-tooltip, .graphiql-dialog):-webkit-any(button) {
  color: hsl(var(--color-neutral));
  font-family: var(--font-family);
  font-size: var(--font-size-body);
  font-weight: var(--font-weight-regular);
...
:is(.graphiql-container, .CodeMirror-info, .CodeMirror-lint-tooltip, .graphiql-dialog):-moz-any(button) {
  color: hsl(var(--color-neutral));
  font-family: var(--font-family);
  font-size: var(--font-size-body);
  font-weight: var(--font-weight-regular);
...
:is(.graphiql-container, .CodeMirror-info, .CodeMirror-lint-tooltip, .graphiql-dialog):is(button) {
  color: hsl(var(--color-neutral));
  font-family: var(--font-family);
  font-size: var(--font-size-body);
  font-weight: var(--font-weight-regular);
...
:is(.graphiql-container, .CodeMirror-info, .CodeMirror-lint-tooltip, .graphiql-dialog) input {
  color: hsl(var(--color-neutral));
  font-family: var(--font-family);
  font-size: var(--font-size-caption);
}
:is(.graphiql-container, .CodeMirror-info, .CodeMirror-lint-tooltip, .graphiql-dialog) input::placeholder {
  color: hsla(var(--color-neutral), var(--alpha-secondary));
}
:is(.graphiql-container, .CodeMirror-info, .CodeMirror-lint-tooltip, .graphiql-dialog) a {
  color: hsl(var(--color-primary));
}
:is(.graphiql-container, .CodeMirror-info, .CodeMirror-lint-tooltip, .graphiql-dialog) a:focus {
